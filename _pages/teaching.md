...
<!-- Welcome! Choose a specialization below:


- [Mathematical Foundations](/teaching/Mathematical Foundations/)
- [Data Science](/teaching/Data Science/) -->


<!-- <h2 class="page-header" style="text-align: center; color: blue;">
  <strong style="color: #cc33cc;">Courses Taught</strong>
</h2>

<p style="text-align: center;">
  Welcome! On this page, you will find a curated list of the courses I have taught over the years. 
  Each course includes materials, lecture notes, and references to help you dive deeper into the subject. 
  Whether you are a beginner or looking to enhance your skills, these courses provide a structured path for learning.
</p>

<p style="text-align: center;">
  Explore the specializations below and click on a link to access the course page.
</p>

<h3 style="color: #cc33cc;">Mathematical Foundations</h3>
<ul>
  <li><a href="/teaching/Mathematical Foundations/">Mathematical Foundations</a></li>
</ul>

<h3 style="color: #cc33cc;">Data Science</h3>
<ul>
  <li><a href="/teaching/Data Science/">Data Science</a></li>
</ul>

<h3 style="color: #cc33cc;">Communication Engineering</h3>
<ul>
  <li><a href="/teaching/Communication Engineering/">Communication Engineering</a></li>
</ul>

<h3 style="color: #cc33cc;">Python Programming</h3>
<ul>
  <li><a href="/teaching/Python/">Python Programming</a></li>
</ul> -->
...
<p style="text-align: justify;">
  Explore the specializations below and click on a specialization to access the course page.
</p>
