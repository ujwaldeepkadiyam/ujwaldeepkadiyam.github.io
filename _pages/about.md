...
subtitle: <a href='#'>Alma Mater:</a> Indian Institute of Technology Guwahati (PhD)<br>Subject Matter Expert, Learning and Development Specialist, Researcher
...
profile:
  ...
  more_info: >
    <p>email: ujwaldeepkadiyam@gmail.com</p>

selected_papers: true # includes a list of papers marked as "selected={true}"
social: true # includes social icons at the bottom of the page

announcements:
  enabled: false # no real news items yet -- _news/ is empty, re-enable once you add some
