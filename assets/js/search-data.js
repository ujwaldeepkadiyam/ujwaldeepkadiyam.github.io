      ...
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "Teaching",handler: () => {
            ...
            },},{id: "teaching-introduction-to-amplitude-modulation",
          title: 'Introduction To Amplitude Modulation',
          description: "",
          section: "Teaching",handler: () => {
              window.location.href = "/teaching/Communiation%20Engineering/Analog_Communications/Amplitude_modulation-1/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/ujwaldeepkadiyam", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0003-0624-3751", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=IxDyNn8AAAAJ", "_blank");
        },
      },{
        id: 'social-scopus',
        title: 'Scopus',
        section: 'Socials',
        handler: () => {
          window.open("https://www.scopus.com/authid/detail.uri?authorId=57209337450", "_blank");
        },
      },{
        id: 'social-work',
        title: 'Work',
        section: 'Socials',
        handler: () => {
          window.open("https://ujwaldeepkadiyam.com", "_blank");
        },
      },{
      id: 'light-theme',
